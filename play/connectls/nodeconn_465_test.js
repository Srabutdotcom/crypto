// openssl s_client -connect smtp.gmail.com:465 -crlf -quiet -msg
...
const SMTP_SERVER = "smtp.gmail.com";//"mail.gmx.com";//"smtp.zoho.com";//"smtp.yandex.com";//"smtp-mail.outlook.com"; //"localhost";//"testtls.com";//
const SMTP_PORT = 465; // For TLS
...
async function sendClientHello(sock, clientHelloForm) {
   ...
   const data = await appKey.aead_client.encrypt(encoder.encode("\r\n"), ContentType.APPLICATION_DATA);
   ...
   console.log("%cresponse after finished client :", "color: green", response)
